...
self.usernameArray = objects!.map{$0.object(forKey: "username") as! String}
self.avaArray = objects!.map{$0.object(forKey: "ava") as! PFFile}
    } else{
...
self.followArray = objects!.map{$0.value(forKey: "followings") as! String}
